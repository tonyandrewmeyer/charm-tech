...
cp -- "$template" .github/dependabot.yml
printf 'Wrote .github/dependabot.yml. Confirm the ecosystem set matches the repo (pip, github-actions by default; uncomment gomod / docker as needed).\n'
