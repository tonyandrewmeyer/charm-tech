...
# Attacker: http://attacker.example/redirect -> http://169.254.169.254/
...
# First request: attacker.example -> 1.2.3.4 (passes validation)
# DNS changes: attacker.example -> 192.168.1.1
