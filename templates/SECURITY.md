<!--
  Charm Tech SECURITY.md template.
  Copy into a repo and replace {{REPO}} with the GitHub repo name (e.g. operator).
  This is the policy our repos have converged on; keep it in sync with this template.
-->
# Security policy
...
[GitHub's security advisory for this project](https://github.com/canonical/{{REPO}}/security/advisories/new). See
